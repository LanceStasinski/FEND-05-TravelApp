...
const createButtons = (data) => {
  ...
  saveBtn.addEventListener("click", () => {
    ...
    const trip = {
      arrival: Client.getDateFromString(
        tripCard.getElementsByClassName("header-arrival")[0].innerHTML
      ),
      departure: Client.getDateFromString(
        tripCard.getElementsByClassName("header-departure")[0].innerHTML
      ),
      ...
      currency:
        tripCard.getElementsByClassName("country-currency")[0].innerHTML,
      ...
      language:
        tripCard.getElementsByClassName("country-language")[0].innerHTML,
